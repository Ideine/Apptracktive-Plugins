...
{
    public class AzureForMobileRemoteTableService<T> : IAzureForMobileRemoteTableService<T> where T : ITableData
    {
        private readonly IMobileServiceClient _client;
        private IMobileServiceTable<T> _remoteTable;
        private bool _isInitialized;

        public AzureForMobileRemoteTableService(IMobileServiceClient client)
        {
            _client = client;
            Initialize();
        }

...
using AzureForMobile.Test.Core;
using Xamarin.Forms;
using Application = Windows.UI.Xaml.Application;
using Frame = Windows.UI.Xaml.Controls.Frame;

namespace AzureForMobile.Test.Uwp
{
    /// <summary>
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                ...
                // Init Ams plugin
                var configuration = new AptkAmsPluginConfiguration(Constants.AmsUrl, Constants.AmsKey, Constants.ModelAssembly);

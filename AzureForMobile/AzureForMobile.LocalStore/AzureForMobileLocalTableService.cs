...
{
    public class AzureForMobileLocalTableService<T> : IAzureForMobileLocalTableService<T> where T : ITableData
    {
        private readonly IAzureForMobileLocalStorePluginConfiguration _localStoreConfiguration;
        private readonly IMobileServiceClient _client;
        private readonly IAzureForMobileLocalStoreService _localStoreService;
        private IMobileServiceSyncTable<T> _localTable;

        public AzureForMobileLocalTableService(IAzureForMobileLocalStorePluginConfiguration localStoreConfiguration, 
            IMobileServiceClient client, 
            IAzureForMobileLocalStoreService localStoreService)
        {
